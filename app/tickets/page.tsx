...
// Dynamic ticket counter component with urgency and countdown
...
export default function TicketsPage() {
    ...
    // Function to trigger confetti with improved mobile support
    ...
    useEffect(() => {
        ...
        // Delay the title drop-in effect slightly
        const titleAnimationTimer = setTimeout(() => {
            setTitleAnimated(true);
        }, 100);

        // Force trigger confetti with delay for better user experience
    ...
    return (
        <div ref={pageRef} className="relative min-h-screen overflow-hidden">
            ...
            <div className="absolute inset-0 flex items-center overflow-hidden pointer-events-none">
                <h1 className={`text-[8rem] md:text-[15rem] font-bold text-white/10 whitespace-nowrap animate-tickets-banner transform transition-all duration-700 ${titleAnimated ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                    TICKETS • BUY NOW • FRANCISCO • HERRERA • IN CONCERT •
                </h1>
            </div>
            ...
            <div className="container mx-auto px-4 sm:px-6 relative z-10 pt-32 pb-16">
                ...
                <div className="text-center mb-16">
                    <div className="flex items-center justify-center mb-5">
                        ...
                        <h2 className={`text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-white uppercase tracking-tight title-3d py-2 transform transition-all duration-1000 ${titleAnimated ? 'translate-y-0 opacity-100 title-pulse' : 'translate-y-[-100px] opacity-0'}`}
                            style={{
                            ...
                            <span className={`text-red-500 block transform transition-all duration-1000 delay-100 ${titleAnimated ? 'translate-y-0 opacity-100 scale-100 francisco-pulse' : 'translate-y-[-50px] opacity-0 scale-95'}`}>FRANCISCO HERRERA</span>
                            <span className={`text-white mt-1 block transform transition-all duration-1000 delay-300 ${titleAnimated ? 'translate-y-0 opacity-100 scale-100 concert-pulse' : 'translate-y-[-30px] opacity-0 scale-95'}`} style={{ border: 'none', boxShadow: 'none', textShadow: '0 2px 0 #cccccc, 0 3px 0 #c9c9c9, 0 4px 0 #bbb, 0 5px 0 #b9b9b9, 0 6px 0 #aaa, 0 7px 1px rgba(0,0,0,.1), 0 0 5px rgba(0,0,0,.1), 0 1px 3px rgba(0,0,0,.3), 0 3px 5px rgba(0,0,0,.2), 0 5px 10px rgba(0,0,0,.25), 0 10px 10px rgba(0,0,0,.2), 0 20px 20px rgba(0,0,0,.15)' }}>IN&nbsp;CONCERT</span>
                        </h2>
                ...
                <div className={`max-w-5xl mx-auto bg-black/40 backdrop-blur-sm rounded-2xl border border-white/10 shadow-2xl overflow-hidden transform transition-all duration-700 ${isAnimated ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                    ...
                    <div className="relative overflow-hidden">
                        ...
                        <div className="absolute bottom-2 sm:bottom-4 left-0 w-full p-2 sm:p-6 bg-black/50 backdrop-blur-[2px]">
                            <div className="inline-block bg-red-500 text-white text-xs px-2 py-0.5 rounded-full font-bold uppercase tracking-wide mb-0.5 sm:mb-2">
                                {t('tickets.venue.name') || 'Francisco Herrera Concert Venue'}
                            </div>
                            <h3 className="text-base sm:text-2xl md:text-4xl font-bold text-white drop-shadow-md">
                    ...
                    <div className="p-6 sm:p-8">
                        ...
                        {/* Ticket options with dynamic ticket counters */}
                ...
                {/* Additional ticket information section */}
                <div className="mt-16 max-w-4xl mx-auto">
                    <div className="bg-black/30 backdrop-blur-sm rounded-2xl border border-white/10 shadow-xl p-6 sm:p-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div>
                                ...
                                <p className="text-white/80 mb-4">
                                    Groups of 10+ receive a 15% discount on standard tickets. Contact the box office for details.
                                </p>
                                ...
                                <p className="text-white/80 mb-4">
                                    Students and seniors (65+) receive a 10% discount with valid ID. Available at the box office only.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-white/80 mb-4">
                                    Tickets are non-refundable but may be transferred to another person. In case of event cancellation, full refunds will be provided.
                                </p>
                                ...
                                <p className="text-white/80 mb-4">
                                    For additional assistance, please contact the City Box Office at (415) 392-4400 or visit <a href="https://www.cityboxoffice.com" target="_blank" rel="noopener noreferrer" className="text-red-400 hover:text-red-300">cityboxoffice.com</a>.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <style jsx global>{`
                ...
                @keyframes title-drop-shadow {
                    0% { filter: drop-shadow(0 0px 0px rgba(0,0,0,0.7)); }
                    70% { filter: drop-shadow(0 25px 15px rgba(0,0,0,0.8)); }
                    100% { filter: drop-shadow(0 15px 10px rgba(0,0,0,0.7)); }
                }
                
                .title-3d {
                    animation: title-drop-shadow 1.2s ease-out forwards;
                }
                ...
                @keyframes francisco-pulse {
                    0%, 100% { text-shadow: 0 2px 0 #cccccc, 0 3px 0 #c9c9c9, 0 4px 0 #bbb, 0 5px 0 #b9b9b9, 0 6px 0 #aaa, 
                    ...
                    50% { text-shadow: 0 2px 0 #cccccc, 0 3px 0 #c9c9c9, 0 4px 0 #bbb, 0 5px 0 #b9b9b9, 0 6px 0 #aaa, 
                                0 7px 1px rgba(0,0,0,.1), 0 0 10px rgba(239,68,68,.2), 0 1px 7px rgba(239,68,68,.4), 
                                0 3px 8px rgba(0,0,0,.2), 0 8px 15px rgba(239,68,68,.3), 0 15px 15px rgba(239,68,68,.2), 
                                0 25px 25px rgba(0,0,0,.15); }
                }
                
                .francisco-pulse {
                    animation: francisco-pulse 3s ease-in-out infinite;
                }
                ...
                @keyframes concert-pulse {
                    0%, 100% { text-shadow: 0 2px 0 #cccccc, 0 3px 0 #c9c9c9, 0 4px 0 #bbb, 0 5px 0 #b9b9b9, 0 6px 0 #aaa, 
                                ...
                                0 20px 20px rgba(0,0,0,.15); }
                    50% { text-shadow: 0 2px 0 #cccccc, 0 3px 0 #c9c9c9, 0 4px 0 #bbb, 0 5px 0 #b9b9b9, 0 6px 0 #aaa, 
                                0 7px 1px rgba(0,0,0,.1), 0 0 10px rgba(255,255,255,.3), 0 1px 7px rgba(255,255,255,.4), 
                                0 3px 8px rgba(0,0,0,.2), 0 8px 15px rgba(255,255,255,.3), 0 15px 15px rgba(255,255,255,.2), 
                                0 25px 25px rgba(0,0,0,.15); }
                }
                
                .concert-pulse {
                    animation: concert-pulse 4s ease-in-out infinite;
                    animation-delay: 1s;
                }
