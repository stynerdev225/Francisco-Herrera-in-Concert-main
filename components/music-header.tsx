        ...
        <div className="sticky top-0 pt-16 sm:pt-12 md:pt-16 pb-2 sm:pb-10 md:pb-12 z-30 bg-gradient-to-r from-purple-700 via-blue-600 to-purple-700">
            <div className="container mx-auto text-center px-4">
                <div className="flex flex-col items-center justify-center">
                    {/* Main F.HERRERA title with enhanced 3D effect - Improved for mobile */}
                    <div className="relative inline-flex items-center justify-center flex-wrap mt-4 sm:mt-0">
                        <span className="text-red-500 text-3xl sm:text-4xl md:text-6xl font-bold mr-1 sm:mr-2 drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]">•</span>
                        <span className="relative text-red-500 text-4xl sm:text-6xl md:text-8xl font-black drop-shadow-[0_3px_3px_rgba(0,0,0,0.8)]">
                            <span className="absolute inset-0 blur-[1px] opacity-60 text-red-400">F.</span>
                            F.
                        </span>
                        <span className="relative text-white text-4xl sm:text-6xl md:text-8xl font-black tracking-tight drop-shadow-[0_3px_3px_rgba(0,0,0,0.8)] hover:translate-y-[1px] transition-transform">HERRERA</span>
                        <span className="text-red-500 text-3xl sm:text-4xl md:text-6xl font-bold ml-1 sm:ml-2 drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]">•</span>
                    </div>

                    {/* Latest Music subtitle with 3D effect */}
                    <h2 className="text-white text-2xl sm:text-3xl md:text-5xl font-bold uppercase tracking-wide mt-4 drop-shadow-[0_2px_2px_rgba(0,0,0,0.7)]">
                        {t("latest.music")}
                    </h2>
